...
const char* elevenlabs_api_key = "06c14a06cbeb9fa5e3dfc443c8e858da7f9c6dda9e0bdc161011cbe4372a25cc";
...
void loop() {
  // Read capacitive touch value: > threshold means touched per your measurements
  uint32_t touchVal = touchRead(TOUCH_PIN);
  bool currentState = (touchVal > 50000);
